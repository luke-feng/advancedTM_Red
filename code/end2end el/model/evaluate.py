...
def _parse_args():
    ...
    parser.add_argument("--ed_datasets", default="HIPE-data-v1.0-train-de.txt_z_HIPE-data-v1.0-dev-de.txt_z_HIPE-data-v1.0-test-de")
    parser.add_argument("--el_datasets", default="HIPE-data-v1.0-train-de.txt_z_HIPE-data-v1.0-dev-de.txt_z_HIPE-data-v1.0-test-de")
