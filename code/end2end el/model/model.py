...
class Model(BaseModel):
    ...
    def init_embeddings(self):
        ...
        print('entity_embeddings_nparray', entity_embeddings_nparray.shape)
        print("self.entity_embeddings_placeholder",self.entity_embeddings_placeholder.shape)
    ...
    def add_lstm_score_op(self):
        with tf.variable_scope("span_emb_ffnn"):
            ...
            if self.args.span_emb_ffnn[0] == 0:
                span_emb_projected = util.projection(self.span_emb, 100)
            else:
    ...
    def add_local_attention_op(self):
        ...
        with tf.variable_scope("attention"):
            ...
            if self.args.attention_on_lstm and self.args.nn_components.find("lstm") != -1:
                ...
                att_x_w = util.projection(self.context_emb, 100)  # if tf.shape(self.context_emb)[-1] != 300 else self.context_emb
