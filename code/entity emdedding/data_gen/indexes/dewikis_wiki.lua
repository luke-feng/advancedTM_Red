...
local crosswikis_textfilename = opt.root_data_dir .. 'generated/de_wikipedia_p_e_m.txt'
print('==> Loading de_wikipedia from file ' .. crosswikis_textfilename)
...
assert(ent_p_e_m_index['Oberpollinger'])
