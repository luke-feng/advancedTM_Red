...
if not ent_p_e_m_index then
  ...
  dofile 'data_gen/indexes/dewikis_wiki.lua'
  dofile 'utils/utils.lua'
  tds = tds or require 'tds'
end

print('\nGenerating train data from HIPE set ')

it, _ = io.open(opt.root_data_dir .. 'basic_data/test_datasets/HIPE/HIPE-aida-test-de.txt')

out_file = opt.root_data_dir .. 'generated/test_train_data/HIPE-aida-test-de-de.csv'
...
local function write_results()
  ...
  if cur_doc_name ~= '' then
    print('cur_doc_name = ' .. cur_doc_name)
