...
elseif opt.word_vecs == 'w2v' then
  ...
  w2v_binfilename = default_path .. 'Word2Vec/2014_tudarmstadt_german_5mincount.bin'
  w2v_t7filename = opt.root_data_dir .. 'generated/2014_tudarmstadt_german_5mincount.t7'
