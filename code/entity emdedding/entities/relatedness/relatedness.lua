...
function load_reltd_set(rel_t7filename, rel_txtfilename, set_type)
  print('==> Loading rel_txtfilename'..rel_txtfilename)
...
if not paths.filep(rewtr_t7filename) then
  ...
  local files = {'HIPE-aida-train-de.csv','HIPE-aida-dev-de.csv','HIPE-aida-test-de.csv'}
  ...
  sorted_rltd_all_ent_wikiids:sort(function(a,b) return tostring(a) < tostring(b)end)
