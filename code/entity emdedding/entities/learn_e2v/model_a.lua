...
if not unit_tests then 
  ...
  folder_name = '/Users/chaofeng/end2end_neural_el/data/nnid_wikiid.txt'
  outfile1 = assert(io.open(folder_name, "w"))
  for ent_thid = 1, get_total_num_ents() do
    local ent_id = get_wikiid_from_thid(ent_thid)
    outfile1:write(ent_thid.."\t"..ent_id.."\n")
  end
  print("write_finish")
  outfile1:close()
