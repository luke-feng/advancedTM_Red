...
wiki_name_map = '/Users/chaofeng/end2end_neural_el/deep-ed/basic_data/wiki_name_map.txt'
mapping_path ='/Users/chaofeng/end2end_neural_el/deep-ed/basic_data/mapping.tsv'
wiki_id_name = '/Users/chaofeng/end2end_neural_el/deep-ed/basic_data/wiki_id_name.tsv'
...
def main():
    ...
    with open(wiki_id_name, 'w') as fout:
        tbar = tqdm.tqdm()
